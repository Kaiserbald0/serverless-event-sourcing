...
import { UpdatePlayerNamePayload } from '@event-sourcing-demo/core/players/playersSchema';
...
export async function main(
  ...
  await EventManager.processEventBridgeEvent<UpdatePlayerNamePayload>({
    eventObject: event.detail.event,
    parsingFuncion: Player.updateName,
  });
}
