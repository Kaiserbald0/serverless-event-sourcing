...
import { UpdatePlayerRolePayloadSchema } from '@event-sourcing-demo/core/players/playersSchema';
...
export async function main(
  ...
  await EventManager.processEventBridgeEvent<UpdatePlayerRolePayloadSchema>({
    eventObject: event.detail.event,
    parsingFuncion: Player.updateRole,
  });
}
